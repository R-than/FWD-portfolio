...
const About = () => {
  return (
    <section id="about" className="bg-gray-300 py-8 min-h-screen flex justify-center items-center">
...
const SkillBox = ({ icon, name, color }) => {
  return (
    <div className="bg-white p-2 rounded-lg shadow-md flex flex-col items-center justify-center hover:scale-105 hover:shadow-lg transition-transform duration-300">
